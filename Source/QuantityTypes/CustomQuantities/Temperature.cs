...
namespace QuantityTypes
{
    ...
    public partial struct Temperature : IQuantity<Temperature>
    {
        ...
        /// </returns>
        public static Temperature Parse(string input, IFormatProvider provider, IUnitProvider unitProvider)
        {
        ...
        /// A <see cref="Temperature"/> that represents the quantity in <paramref name="input" />. 
        /// </returns>
        public static Temperature Parse(string input, IFormatProvider provider = null)
        {
        ...
        public static bool TryParse(string input, IFormatProvider provider, IUnitProvider unitProvider, out Temperature result)
        {
            if (unitProvider == null)
            {
                unitProvider = provider as IUnitProvider ?? UnitProvider.Default;
        ...
        /// <returns>
        /// The <see cref="Temperature"/> .
        /// </returns>
        public static Temperature ParseJson(string input)
        {
        ...
        /// <summary>
        /// Implements the operator * between a scalar and a temperature unit.
        /// </summary>
        /// <param name="x">
        /// The scalar factor. 
        /// </param>
        ...
        /// <summary>
        /// Compares this instance to the specified <see cref="Temperature"/> and returns an indication of their relative values.
        /// </summary>
        /// <param name="other">
        /// The other <see cref="Temperature"/> . 
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Determines if the specified <see cref="Temperature"/> is equal to this instance.
        /// </summary>
        /// <param name="other">
        /// The other <see cref="Temperature"/> . 
        /// </param>
