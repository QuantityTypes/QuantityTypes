// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RadiationAbsorbedDose.cs" company="Units for .NET">
//   http://units.codeplex.com, license: Ms-PL
// </copyright>
// <summary>
//   Represents a RadiationAbsorbedDose quantity.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Units
{
    ...
    public partial struct RadiationAbsorbedDose : IQuantity<RadiationAbsorbedDose>
    {
        ...
        /// </summary>
        [Unit("Gy", true)]
        public static RadiationAbsorbedDose Gray = new RadiationAbsorbedDose(1);

        /// <summary>
        /// Gets or sets the RadiationAbsorbedDose as a string.
        /// </summary>
        ...
        /// </returns>
        public static RadiationAbsorbedDose Parse(string input, IUnitProvider provider = null)
        {
            if (provider == null)
            {
