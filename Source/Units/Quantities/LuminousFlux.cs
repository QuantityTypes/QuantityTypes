// --------------------------------------------------------------------------------------------------------------------
// <copyright file="LuminousFlux.cs" company="Units for .NET">
//   http://units.codeplex.com, license: Ms-PL
// </copyright>
// <summary>
//   Represents a LuminousFlux quantity.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Units
{
    ...
    public partial struct LuminousFlux : IQuantity<LuminousFlux>
    {
        ...
        /// </summary>
        [Unit("lm", true)]
        public static LuminousFlux Lumen = new LuminousFlux(1);

        /// <summary>
        /// Gets or sets the LuminousFlux as a string.
        /// </summary>
        ...
        /// </returns>
        public static LuminousFlux Parse(string input, IUnitProvider provider = null)
        {
            if (provider == null)
            {
